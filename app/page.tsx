...
async function getPrestasi() {
  try {
    ...
    params.set('fields', 'id,judul,slug,nama_lomba,peringkat,tingkat,tahun,kategori');
...
export default async function HomePage() {
  ...
  const [lomba, prestasi, expo, upcomingDeadline] = await Promise.all([
    getLomba(),
    getPrestasi(),
    getExpo(),
    getUpcomingDeadline(),
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
                ...
                <Countdown 
                  targetDate={upcomingDeadline || "2026-02-08T23:59:59"} 
                  variant="hero"
                  className="text-xl"
                />
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="font-semibold">{prestasi.length > 0 ? 'Tim Berprestasi' : 'Budi Santoso'}</p>
                    <p className="text-sm text-white/70">
                      {prestasi.length > 0 ? `${prestasi[0].peringkat} - ${prestasi[0].title}` : 'Juara 1 - Hackathon Nasional'}
                    </p>
                  </div>
        ...
        <div className="container-apm">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-primary mb-1">1,500+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-secondary mb-1">5,000+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-accent mb-1">20,000+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-success mb-1">100+</div>
