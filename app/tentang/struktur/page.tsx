...
const strukturOrganisasi = {
    pembina: {
        nama: 'Dr. Ir. Awan Setiawan, M.T.',
        jabatan: 'Pembina APM',
        nip: '196805151994031002',
        unit: 'Wakil Direktur III',
        foto: null,
        email: 'awan.setiawan@polinema.ac.id',
    },
    ketua: {
        nama: 'Dr. Ahmad Fauzi, S.T., M.T.',
        jabatan: 'Ketua APM Polinema',
        nip: '197803201999031001',
    ...
    wakil: {
        nama: 'Rina Dewi Indahsari, S.Kom., M.Kom.',
        jabatan: 'Wakil Ketua APM',
        nip: '198507152010012002',
        unit: 'Jurusan Teknik Elektro',
        foto: null,
        email: 'rina.dewi@polinema.ac.id',
        tugas: [
    ...
    divisi: [
        {
            ...
            kepala: {
                nama: 'Citra Dewi Lestari, S.Pd., M.Pd.',
                jabatan: 'Kepala Divisi',
                nip: '198712082014042001',
                unit: 'Jurusan Administrasi Niaga',
                foto: null,
            },
            anggota: [
                { nama: 'Eko Prasetyo, S.T.', jabatan: 'Koordinator Lomba Nasional', unit: 'JTI' },
                { nama: 'Fitri Handayani, S.Kom.', jabatan: 'Koordinator Lomba Internasional', unit: 'JTE' },
                { nama: 'Galih Pratama', jabatan: 'Staff Admin', unit: 'Mahasiswa JTI' },
            ],
            tugas: [
        ...
        },
        {
            ...
            kepala: {
                nama: 'Diana Pratiwi, S.T., M.T.',
                jabatan: 'Kepala Divisi',
                nip: '198905172016042001',
                unit: 'Jurusan Teknik Mesin',
                foto: null,
            },
            anggota: [
                { nama: 'Hana Kusuma, S.Pd.', jabatan: 'Koordinator Prestasi', unit: 'JAK' },
                { nama: 'Irfan Ramadhan', jabatan: 'Staff Dokumentasi', unit: 'Mahasiswa JTI' },
                { nama: 'Jasmine Putri', jabatan: 'Staff Verifikasi', unit: 'Mahasiswa JAN' },
            ],
            tugas: [
        ...
        },
        {
            ...
            kepala: {
                nama: 'Eko Wahyudi, S.E., M.M.',
                jabatan: 'Kepala Divisi',
                nip: '199103222018041001',
                unit: 'Jurusan Administrasi Niaga',
                foto: null,
            },
            anggota: [
                { nama: 'Karina Salsabila, S.Kom.', jabatan: 'Koordinator Event', unit: 'JTI' },
                { nama: 'Lina Marlina', jabatan: 'Staff Logistik', unit: 'Mahasiswa JAK' },
                { nama: 'Muhammad Rizky', jabatan: 'Staff Publikasi', unit: 'Mahasiswa JTI' },
            ],
            tugas: [
        ...
        },
        {
            ...
            kepala: {
                nama: 'Fitria Rahma, S.Ds., M.Ds.',
                jabatan: 'Kepala Divisi',
                nip: '199208152019042001',
                unit: 'Jurusan Teknologi Informasi',
                foto: null,
            },
            anggota: [
                { nama: 'Nadia Pertiwi, S.Kom.', jabatan: 'Web Developer', unit: 'JTI' },
                { nama: 'Oscar Pratama', jabatan: 'Graphic Designer', unit: 'Mahasiswa JTI' },
                { nama: 'Putri Ayu', jabatan: 'Social Media Manager', unit: 'Mahasiswa JAN' },
            ],
            tugas: [
        ...
        },
        {
            ...
            kepala: {
                nama: 'Gilang Ramadhan, S.E., M.M.',
                jabatan: 'Kepala Divisi',
                nip: '199004102018041001',
                unit: 'Jurusan Akuntansi',
                foto: null,
            },
            anggota: [
                { nama: 'Qori Agustina, S.E.', jabatan: 'Koordinator Sponsorship', unit: 'JAK' },
                { nama: 'Rendi Setiawan', jabatan: 'Staff Partnership', unit: 'Mahasiswa JAN' },
            ],
            tugas: [
    ...
    koordinatorJurusan: [
        { jurusan: 'Jurusan Teknologi Informasi', kode: 'JTI', nama: 'Dr. Budi Harijanto, S.T., M.T.', foto: null },
        { jurusan: 'Jurusan Teknik Elektro', kode: 'JTE', nama: 'Ir. Eko Nurcahyo, M.T.', foto: null },
        { jurusan: 'Jurusan Teknik Mesin', kode: 'JTM', nama: 'Dr. Rini Hastuti, M.T.', foto: null },
        { jurusan: 'Jurusan Teknik Sipil', kode: 'JTS', nama: 'Ir. Dian Pramana, M.T.', foto: null },
        { jurusan: 'Jurusan Teknik Kimia', kode: 'JTK', nama: 'Dr. Sri Wahyuni, M.T.', foto: null },
        { jurusan: 'Jurusan Akuntansi', kode: 'JAK', nama: 'Dra. Ani Wijayanti, M.M.', foto: null },
        { jurusan: 'Jurusan Administrasi Niaga', kode: 'JAN', nama: 'Dr. Tono Susanto, M.M.', foto: null },
    ]
};
